...
<div class=" Main-Content ">
   <div class="wrapper2">
       ...
       <form action="" method="POST">
        ...
        <tr>
            <td>Qty:</td>
            <td><input type="text" name="qty" value="<?php  echo  $qty;  ?>"></b></td>
        </tr>
        <tr>
            <td>Status:</td>
            <td>
        ...
        <?php
         if(isset($_POST['submit']))
         {
            ...
            $qty=$_POST['qty'];  
            $total=$price*$qty;
            $status=$_POST['status'];//ordered, on delivery,delivery,canceled
         ...
         $res2= mysqli_query($conn,$query);
             ...
             if($res2==True)
             {
                 ...
                 $_SESSION['update']="<div class='error'>Fail to Order</div>";
                 //Redirect to manage page
                 header("location:".SITEURL.'Admin/manage-order.php');
